    ...
    <section className="relative flex items-center justify-center w-full min-h-[100svh] overflow-hidden px-4 sm:px-8 lg:px-16">
      <div className="relative z-10 flex flex-col-reverse sm:flex-row items-center sm:items-center gap-6 sm:gap-10 lg:gap-20 w-full max-w-6xl">
        ...
        <div className="relative shrink-0 group">
          {/* Glow behind */}
          <div className="absolute -inset-6 rounded-[2rem] bg-primary/10 blur-3xl opacity-0 sm:group-hover:opacity-60 transition-opacity duration-700" />
          {/* Card — photo fills entire frame */}
          <div className="relative w-80 sm:w-72 lg:w-80 aspect-[3/4] rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl transition-all duration-500 sm:hover:scale-[1.03] sm:hover:border-primary/30 sm:hover:shadow-[0_0_50px_-12px_rgba(43,75,238,0.4)]">
            {/* Photo */}
            <Image
              alt="Portrait"
              src="/Haqil.webp"
